...
export class OpenAI extends Core.APIClient {
     ...
     * API Client for interfacing with the OpenAI API.
     *
     * @param {string | undefined} [opts.apiKey=process.env['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'] ?? undefined]
     ...
     */
    constructor({ baseURL = Core.readEnv('http://localhost:5555/getRecommendations'), apiKey = Core.readEnv('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'), organization = Core.readEnv('OPENAI_ORG_ID') ?? null, project = Core.readEnv('OPENAI_PROJECT_ID') ?? null, ...opts } = {}) {
        if (apiKey === undefined) {
        ...
        const options = {
            ...
            project,
            ...opts,
            baseURL: baseURL || `http://localhost:5555/getRecommendations`,
        };
